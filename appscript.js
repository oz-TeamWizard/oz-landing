...
function doPost(e) {
  try {
    ...
    const body = `
안녕하세요, ${email.split("@")[0]}님! mealStack팀 입니다.

mealStack팀의 자체 벌크업 식단 도시락 예약 리스트에 추가되었습니다.
...
저희가 분석한 결과, 회원님께서는 **'${description}'** 목표 달성을 위해
하루 **${protein}g**의 단백질 섭취가 필요하신 것을 확인했습니다.

mealStack은 식단 도시락이 런칭 된다면, 추가적인 예약 안내를 통해서, 목표 체형을 달성할 수 있도록,
최고의 식단을 준비할 예정입니다.
더 이상 직접 번거롭게 식단을 계산하고 요리할 필요 없이,
문 앞으로 배송되는 건강하고 저렴한 식사를 제공하기 위해 만반의 준비를 해보겠습니다.
